...
set sexxml = $rfile:r"_sex.xml"
  ...
  set slices = "/home/data/alvaro/gns_gd/gns1/H/B6/cubes_gd/slices/$chip/"
  set out_put =  "/home/data/alvaro/gns_gd/gns1/H/B6/cubes_gd/slices/sex_slices/$chip/"
  set psf_ima = "/home/data/alvaro/gns_gd/gns1/H/B6/cubes_gd/slices/psfex_ima/$chip/"
  set psf_plots = "/home/data/alvaro/gns_gd/gns1/H/B6/cubes_gd/slices/psfex_plots/$chip/"
