...
pruebas = '/home/data/alvaro/gns_gd/gns1/H/B6/cubes_gd/slices/pruebas/'
field = 'B6'
folder = '/home/data/alvaro/gns_gd/gns1/H/B6/cubes_gd/slices/'

all_chips = '/home/data/alvaro/gns_gd/gns1/H/B6/cubes_gd/slices/all_chips/'
n_fits = glob.glob(folder + 'chip1/%s_image_c1*.weight.fits'%(field))
...
# for n in range(1, 2):
    ...
    wcs_list = []
# for n in range(1, 2):
    fits_files = [folder + 'chip1/%s_image_c1.%04d.fits'%(field,n), 
                  folder + 'chip2/%s_image_c2.%04d.fits'%(field,n), 
                  folder + 'chip3/%s_image_c3.%04d.fits'%(field,n), 
                  folder + 'chip4/%s_image_c4.%04d.fits'%(field,n)]
    fits_masks = [folder + 'chip1/%s_image_c1.%04d.weight.fits'%(field,n), 
                  folder + 'chip2/%s_image_c2.%04d.weight.fits'%(field,n), 
                  folder + 'chip3/%s_image_c3.%04d.weight.fits'%(field,n), 
                  folder + 'chip4/%s_image_c4.%04d.weight.fits'%(field,n)]
